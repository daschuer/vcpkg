function(z_vcpkg_extract_source_archive_deprecated_mode archive working_directory)
    ...
    if(NOT EXISTS "${working_directory}/${archive_filename}.extracted")
        message(STATUS "Extracting source 1 ${archive}")
...
function(vcpkg_extract_source_archive)
    ...
    Please use the `vcpkg_extract_source_archive(<out-var> ARCHIVE <archive>)` form.")
        ...
        if(ARGC EQUAL "1")
            ...
            message(STATUS "working_directory arg1 ${working_directory}")
        else()
            set(working_directory "${ARGV1}")
            message(STATUS "working_directory arg2 ${working_directory}")
        endif()
    ...
    message(STATUS "CURRENT_BUILDTREES_DIR 1 ${CURRENT_BUILDTREES_DIR}")
    ...
    message(STATUS "working_directory 1 ${working_directory}")
    ...
    message(STATUS "working_directory 2 ${working_directory}")

    if(_VCPKG_EDITABLE AND EXISTS "${source_path}")
        set("${out_source_path}" "${source_path}" PARENT_SCOPE)
        message(STATUS "Using source at 2 ${source_path}")
        return()
    ...
    message(STATUS "Extracting source 2 ${arg_ARCHIVE}")
    ...
    set("${out_source_path}" "${source_path}" PARENT_SCOPE)
    message(STATUS "Using source at 3 ${source_path}")
endfunction()
