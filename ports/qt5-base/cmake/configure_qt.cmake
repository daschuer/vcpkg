function(configure_qt)
    ...
    foreach(_buildname ${BUILDTYPES})
        ...
        set(EXCLUDE_FAGS_REGEX "-arch [^-]*|-machine:[^-]*")
        ...
        string(REGEX REPLACE "${EXCLUDE_FAGS_REGEX}" "" _C_FLAGS "${VCPKG_COMBINED_C_FLAGS_${_buildname}}")
        qmake_add_flags("QMAKE_CFLAGS_${_buildname}" "+=" "${_C_FLAGS}")
        string(REGEX REPLACE "${EXCLUDE_FAGS_REGEX}" "" _CXX_FLAGS "${VCPKG_COMBINED_CXX_FLAGS_${_buildname}}")
        qmake_add_flags("QMAKE_CXXFLAGS_${_buildname}" "+=" "${_CXX_FLAGS}")
        string(REGEX REPLACE "${EXCLUDE_FAGS_REGEX}" "" _SHARED_LINKER_FLAGS "${VCPKG_COMBINED_SHARED_LINKER_FLAGS_${_buildname}}")
        qmake_add_flags("QMAKE_LFLAGS" "+=" "${_SHARED_LINKER_FLAGS}")
        qmake_add_flags("QMAKE_LFLAGS_SHLIB" "+=" "${_SHARED_LINKER_FLAGS}")
        string(REGEX REPLACE "${EXCLUDE_FAGS_REGEX}" "" _MODULE_LINKER_FLAGS "${VCPKG_COMBINED_MODULE_LINKER_FLAGS_${_buildname}}")
        qmake_add_flags("QMAKE_LFLAGS_PLUGIN" "+=" "${_MODULE_LINKER_FLAGS}")
        string(REGEX REPLACE "${EXCLUDE_FAGS_REGEX}" "" _STATIC_LINKER_FLAGS "${VCPKG_COMBINED_STATIC_LINKER_FLAGS_${_buildname}}")
        qmake_add_flags("QMAKE_LIBFLAGS_${_buildname}" "+=" "${_STATIC_LINKER_FLAGS}")
