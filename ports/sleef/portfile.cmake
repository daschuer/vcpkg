...
if(VCPKG_LIBRARY_LINKAGE STREQUAL dynamic)
    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "release")
        if(VCPKG_TARGET_IS_WINDOWS)
            ...
            file(COPY "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel/bin/mkrename.exe" DESTINATION "${CURRENT_PACKAGES_DIR}/bin")
        endif()
    endif()
    if(NOT DEFINED VCPKG_BUILD_TYPE OR VCPKG_BUILD_TYPE STREQUAL "debug")
        if(VCPKG_TARGET_IS_WINDOWS)
            ...
            file(COPY "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-sbg/bin/mkrename.exe" DESTINATION "${CURRENT_PACKAGES_DIR}/debug/bin")
        endif()
    endif()
endif()
